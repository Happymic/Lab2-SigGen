...
VL_INLINE_OPT void Vsinegen___024root___nba_sequent__TOP__0(Vsinegen___024root* vlSelf) {
    ...
    // Body
    __Vdly__sinegen__DOT__address = vlSelfRef.sinegen__DOT__address;
    __Vdly__sinegen__DOT__address = ((IData)(vlSelfRef.rst)
                                      ? 0U : (0xffU 
    ...
    vlSelfRef.sinegen__DOT__address = __Vdly__sinegen__DOT__address;
}
